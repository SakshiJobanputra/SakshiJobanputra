...
import os.path
import shutil
import SOECE13085_SAKSHI_RAMESHBHAI_JOBANPUTRA_gui
...
source = SOECE13085_SAKSHI_RAMESHBHAI_JOBANPUTRA_gui.source
destination = SOECE13085_SAKSHI_RAMESHBHAI_JOBANPUTRA_gui.destination
